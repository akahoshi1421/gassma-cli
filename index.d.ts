...
export type Gassmaシート1nameFilterConditions = {
  equals?: "abc" | "def" | "hij" | null;
  not?: "abc" | "def" | "hij" | null;
  in?: ("abc" | "def" | "hij")[];
  notIn?: ("abc" | "def" | "hij")[];
  lt?: "abc" | "def" | "hij";
  lte?: "abc" | "def" | "hij";
...
export type Gassmaシート1WhereUse = {
  "id"?: number | null | Gassmaシート1idFilterConditions;
  "name"?: "abc" | "def" | "hij" | null | Gassmaシート1nameFilterConditions;
...
export type Gassmaシート2WhereUse = {
  ...
  "is"?: boolean | null | Gassmaシート2isFilterConditions;
...
export type Gassmaシート1HavingUse = {
  "id"?: number | null | Gassmaシート1idHavingCore;
  "name"?: "abc" | "def" | "hij" | null | Gassmaシート1nameHavingCore;
...
export type Gassmaシート2HavingUse = {
  ...
  "is"?: boolean | null | Gassmaシート2isHavingCore;
