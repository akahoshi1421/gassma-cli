...
import { getGassmaCountResult } from "./typeGenerate/gassmaCountResult";
...
import { getGassmaUpdateManyAndReturnData } from "./typeGenerate/gassmaUpdateManyAndReturnData";
...
const generater = (
  ...
  result += getGassmaUpdateManyAndReturnData(dictYaml, schema, strict);
